                ...
                <div class="card-body">
                    <!-- <form method="POST"  action="{{ route('register') }}" enctype="multipart/form-data"> -->
                        ...
                        <div class="form-group row">
                          ...
                          {!! Form::label('level','Membership Type',['class'=>'col-md-4 col-form-label text-md-right']) !!}
                          <div class="col-md-6">
                        ...
                        <div class="form-group row">
                          ...
                          {!! Form::label('image','Profile Image',['class'=>'col-md-4 col-form-label text-md-right']) !!}
                          <div class="col-md-6">
