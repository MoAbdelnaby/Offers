...
<div class="form-group">
  ...
  {!! Form::textarea('keywords',setting()->keywords,['class'=>'form-control', 'placeholder'=>'ex: content,supermarket,offers,products']) !!}
</div>
...
<div class="form-group">
  ...
  {!! Form::select('status',['open'=>trans('admin.opened'),'close'=>trans('admin.closed')],setting()->status,['class'=>'form-control']) !!}
