...
<script type="text/javascript">
  ...
  $('#jstree').on('changed.jstree', function(e,data,name) {
    var i , j , r = [];
    var name = [];
...
<div class="box">
  ...
  <div class="box-body">
     @if (auth()->guard('admin')->user()->hasPermission('update_departments'))
    <a href="" class="btn btn-info edit_dep showbtn_control hidden"><i class="fa fa-edit"></i> {{ trans('admin.edit') }}</a>
    @endif
    @if (auth()->guard('admin')->user()->hasPermission('delete_departments'))
