...
<div class="container-fluid">
          ...
          <div id="store">
            ...
            <div class="row">
              <div class="md-12">
                <h1 class="text-center" style="font-size: 38px; font-weight: bold; margin-top: 30px"> العروض الأخيرة</h1>
              </div>
              <!-- Product Single -->
                ...
                <div class="product product-single">
                  ...
                  <div class="product-body">
                    ...
                    <div class="product-btns">
                      <a href="{{ url('admin/adds/'.$add->id) }}" class="main-btn icon-btn"><i class="fa fa-link"></i></a>
